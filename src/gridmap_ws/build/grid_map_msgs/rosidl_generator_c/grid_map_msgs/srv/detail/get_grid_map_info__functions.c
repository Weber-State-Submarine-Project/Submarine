...
grid_map_msgs__srv__GetGridMapInfo_Request__create()
{
  ...
  grid_map_msgs__srv__GetGridMapInfo_Request * msg = (grid_map_msgs__srv__GetGridMapInfo_Request *)allocator.allocate(sizeof(grid_map_msgs__srv__GetGridMapInfo_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
grid_map_msgs__srv__GetGridMapInfo_Request__Sequence__init(grid_map_msgs__srv__GetGridMapInfo_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (grid_map_msgs__srv__GetGridMapInfo_Request *)allocator.zero_allocate(size, sizeof(grid_map_msgs__srv__GetGridMapInfo_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  grid_map_msgs__srv__GetGridMapInfo_Request__Sequence * array = (grid_map_msgs__srv__GetGridMapInfo_Request__Sequence *)allocator.allocate(sizeof(grid_map_msgs__srv__GetGridMapInfo_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  grid_map_msgs__srv__GetGridMapInfo_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    grid_map_msgs__srv__GetGridMapInfo_Request * data =
      (grid_map_msgs__srv__GetGridMapInfo_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!grid_map_msgs__srv__GetGridMapInfo_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          grid_map_msgs__srv__GetGridMapInfo_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  grid_map_msgs__srv__GetGridMapInfo_Response * msg = (grid_map_msgs__srv__GetGridMapInfo_Response *)allocator.allocate(sizeof(grid_map_msgs__srv__GetGridMapInfo_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
grid_map_msgs__srv__GetGridMapInfo_Response__Sequence__init(grid_map_msgs__srv__GetGridMapInfo_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (grid_map_msgs__srv__GetGridMapInfo_Response *)allocator.zero_allocate(size, sizeof(grid_map_msgs__srv__GetGridMapInfo_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  grid_map_msgs__srv__GetGridMapInfo_Response__Sequence * array = (grid_map_msgs__srv__GetGridMapInfo_Response__Sequence *)allocator.allocate(sizeof(grid_map_msgs__srv__GetGridMapInfo_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  grid_map_msgs__srv__GetGridMapInfo_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    grid_map_msgs__srv__GetGridMapInfo_Response * data =
      (grid_map_msgs__srv__GetGridMapInfo_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!grid_map_msgs__srv__GetGridMapInfo_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          grid_map_msgs__srv__GetGridMapInfo_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
