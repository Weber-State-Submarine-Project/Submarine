...
void fetch_function__GridMap__layers(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__GridMap__layers(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__GridMap__layers(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__GridMap__layers(untyped_member, index));
...
void fetch_function__GridMap__basic_layers(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__GridMap__basic_layers(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__GridMap__basic_layers(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__GridMap__basic_layers(untyped_member, index));
  const auto & value = *reinterpret_cast<const std::string *>(untyped_value);
  item = value;
}
...
void fetch_function__GridMap__data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std_msgs::msg::Float32MultiArray *>(
    get_const_function__GridMap__data(untyped_member, index));
  auto & value = *reinterpret_cast<std_msgs::msg::Float32MultiArray *>(untyped_value);
  value = item;
}

void assign_function__GridMap__data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std_msgs::msg::Float32MultiArray *>(
    get_function__GridMap__data(untyped_member, index));
  const auto & value = *reinterpret_cast<const std_msgs::msg::Float32MultiArray *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GridMap_message_member_array[7] = {
  ...
  },
  {
    ...
    fetch_function__GridMap__layers,  // fetch(index, &value) function pointer
    assign_function__GridMap__layers,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__GridMap__basic_layers,  // fetch(index, &value) function pointer
    assign_function__GridMap__basic_layers,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__GridMap__data,  // fetch(index, &value) function pointer
    assign_function__GridMap__data,  // assign(index, value) function pointer
