...
enum
{
  btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Sleep in the package btcpp_ros2_interfaces.
typedef struct btcpp_ros2_interfaces__action__Sleep_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  btcpp_ros2_interfaces__action__Sleep_SendGoal_Request__Sequence request;
  btcpp_ros2_interfaces__action__Sleep_SendGoal_Response__Sequence response;
} btcpp_ros2_interfaces__action__Sleep_SendGoal_Event;

// Struct for a sequence of btcpp_ros2_interfaces__action__Sleep_SendGoal_Event.
typedef struct btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence
{
...
enum
{
  btcpp_ros2_interfaces__action__Sleep_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  btcpp_ros2_interfaces__action__Sleep_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Sleep in the package btcpp_ros2_interfaces.
typedef struct btcpp_ros2_interfaces__action__Sleep_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  btcpp_ros2_interfaces__action__Sleep_GetResult_Request__Sequence request;
  btcpp_ros2_interfaces__action__Sleep_GetResult_Response__Sequence response;
} btcpp_ros2_interfaces__action__Sleep_GetResult_Event;

// Struct for a sequence of btcpp_ros2_interfaces__action__Sleep_GetResult_Event.
typedef struct btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence
{
