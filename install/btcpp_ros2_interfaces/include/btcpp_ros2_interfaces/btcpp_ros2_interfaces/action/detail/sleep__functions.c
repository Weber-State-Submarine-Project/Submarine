...
btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__init(btcpp_ros2_interfaces__action__Sleep_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!btcpp_ros2_interfaces__action__Sleep_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!btcpp_ros2_interfaces__action__Sleep_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__fini(btcpp_ros2_interfaces__action__Sleep_SendGoal_Event * msg)
{
  ...
  // request
  btcpp_ros2_interfaces__action__Sleep_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  btcpp_ros2_interfaces__action__Sleep_SendGoal_Response__Sequence__fini(&msg->response);
}
...
btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__are_equal(const btcpp_ros2_interfaces__action__Sleep_SendGoal_Event * lhs, const btcpp_ros2_interfaces__action__Sleep_SendGoal_Event * rhs)
{
  ...
  // request
  if (!btcpp_ros2_interfaces__action__Sleep_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!btcpp_ros2_interfaces__action__Sleep_SendGoal_Response__Sequence__are_equal(
  ...
  btcpp_ros2_interfaces__action__Sleep_SendGoal_Event * output)
{
  ...
  // request
  if (!btcpp_ros2_interfaces__action__Sleep_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!btcpp_ros2_interfaces__action__Sleep_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  btcpp_ros2_interfaces__action__Sleep_SendGoal_Event * msg = (btcpp_ros2_interfaces__action__Sleep_SendGoal_Event *)allocator.allocate(sizeof(btcpp_ros2_interfaces__action__Sleep_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(btcpp_ros2_interfaces__action__Sleep_SendGoal_Event));
  bool success = btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence__init(btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  btcpp_ros2_interfaces__action__Sleep_SendGoal_Event * data = NULL;

  if (size) {
    data = (btcpp_ros2_interfaces__action__Sleep_SendGoal_Event *)allocator.zero_allocate(size, sizeof(btcpp_ros2_interfaces__action__Sleep_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence__fini(btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence * array = (btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence *)allocator.allocate(sizeof(btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence__destroy(btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence__are_equal(const btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence * lhs, const btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(btcpp_ros2_interfaces__action__Sleep_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    btcpp_ros2_interfaces__action__Sleep_SendGoal_Event * data =
      (btcpp_ros2_interfaces__action__Sleep_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!btcpp_ros2_interfaces__action__Sleep_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
btcpp_ros2_interfaces__action__Sleep_GetResult_Event__init(btcpp_ros2_interfaces__action__Sleep_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    btcpp_ros2_interfaces__action__Sleep_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!btcpp_ros2_interfaces__action__Sleep_GetResult_Request__Sequence__init(&msg->request, 0)) {
    btcpp_ros2_interfaces__action__Sleep_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!btcpp_ros2_interfaces__action__Sleep_GetResult_Response__Sequence__init(&msg->response, 0)) {
    btcpp_ros2_interfaces__action__Sleep_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
btcpp_ros2_interfaces__action__Sleep_GetResult_Event__fini(btcpp_ros2_interfaces__action__Sleep_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  btcpp_ros2_interfaces__action__Sleep_GetResult_Request__Sequence__fini(&msg->request);
  // response
  btcpp_ros2_interfaces__action__Sleep_GetResult_Response__Sequence__fini(&msg->response);
}
...
btcpp_ros2_interfaces__action__Sleep_GetResult_Event__are_equal(const btcpp_ros2_interfaces__action__Sleep_GetResult_Event * lhs, const btcpp_ros2_interfaces__action__Sleep_GetResult_Event * rhs)
{
  ...
  // request
  if (!btcpp_ros2_interfaces__action__Sleep_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!btcpp_ros2_interfaces__action__Sleep_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  btcpp_ros2_interfaces__action__Sleep_GetResult_Event * output)
{
  ...
  // request
  if (!btcpp_ros2_interfaces__action__Sleep_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!btcpp_ros2_interfaces__action__Sleep_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  btcpp_ros2_interfaces__action__Sleep_GetResult_Event * msg = (btcpp_ros2_interfaces__action__Sleep_GetResult_Event *)allocator.allocate(sizeof(btcpp_ros2_interfaces__action__Sleep_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(btcpp_ros2_interfaces__action__Sleep_GetResult_Event));
  bool success = btcpp_ros2_interfaces__action__Sleep_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence__init(btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  btcpp_ros2_interfaces__action__Sleep_GetResult_Event * data = NULL;

  if (size) {
    data = (btcpp_ros2_interfaces__action__Sleep_GetResult_Event *)allocator.zero_allocate(size, sizeof(btcpp_ros2_interfaces__action__Sleep_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = btcpp_ros2_interfaces__action__Sleep_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        btcpp_ros2_interfaces__action__Sleep_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence__fini(btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      btcpp_ros2_interfaces__action__Sleep_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence * array = (btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence *)allocator.allocate(sizeof(btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence__destroy(btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence__are_equal(const btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence * lhs, const btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!btcpp_ros2_interfaces__action__Sleep_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  btcpp_ros2_interfaces__action__Sleep_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(btcpp_ros2_interfaces__action__Sleep_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    btcpp_ros2_interfaces__action__Sleep_GetResult_Event * data =
      (btcpp_ros2_interfaces__action__Sleep_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!btcpp_ros2_interfaces__action__Sleep_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          btcpp_ros2_interfaces__action__Sleep_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!btcpp_ros2_interfaces__action__Sleep_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
