...
void Sleep_SendGoal_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) btcpp_ros2_interfaces::action::Sleep_SendGoal_Event(_init);
}

void Sleep_SendGoal_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<btcpp_ros2_interfaces::action::Sleep_SendGoal_Event *>(message_memory);
  typed_message->~Sleep_SendGoal_Event();
}

size_t size_function__Sleep_SendGoal_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<btcpp_ros2_interfaces::action::Sleep_SendGoal_Request> *>(untyped_member);
  return member->size();
}

const void * get_const_function__Sleep_SendGoal_Event__request(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<btcpp_ros2_interfaces::action::Sleep_SendGoal_Request> *>(untyped_member);
  return &member[index];
}

void * get_function__Sleep_SendGoal_Event__request(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<btcpp_ros2_interfaces::action::Sleep_SendGoal_Request> *>(untyped_member);
  return &member[index];
}

void fetch_function__Sleep_SendGoal_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const btcpp_ros2_interfaces::action::Sleep_SendGoal_Request *>(
    get_const_function__Sleep_SendGoal_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<btcpp_ros2_interfaces::action::Sleep_SendGoal_Request *>(untyped_value);
  value = item;
}

void assign_function__Sleep_SendGoal_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<btcpp_ros2_interfaces::action::Sleep_SendGoal_Request *>(
    get_function__Sleep_SendGoal_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const btcpp_ros2_interfaces::action::Sleep_SendGoal_Request *>(untyped_value);
  item = value;
}

void resize_function__Sleep_SendGoal_Event__request(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<btcpp_ros2_interfaces::action::Sleep_SendGoal_Request> *>(untyped_member);
  member->resize(size);
...
size_t size_function__Sleep_SendGoal_Event__response(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<btcpp_ros2_interfaces::action::Sleep_SendGoal_Response> *>(untyped_member);
  return member->size();
}

const void * get_const_function__Sleep_SendGoal_Event__response(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<btcpp_ros2_interfaces::action::Sleep_SendGoal_Response> *>(untyped_member);
  return &member[index];
}

void * get_function__Sleep_SendGoal_Event__response(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<btcpp_ros2_interfaces::action::Sleep_SendGoal_Response> *>(untyped_member);
  return &member[index];
}

void fetch_function__Sleep_SendGoal_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const btcpp_ros2_interfaces::action::Sleep_SendGoal_Response *>(
    get_const_function__Sleep_SendGoal_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<btcpp_ros2_interfaces::action::Sleep_SendGoal_Response *>(untyped_value);
  value = item;
}

void assign_function__Sleep_SendGoal_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<btcpp_ros2_interfaces::action::Sleep_SendGoal_Response *>(
    get_function__Sleep_SendGoal_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const btcpp_ros2_interfaces::action::Sleep_SendGoal_Response *>(untyped_value);
  item = value;
}

void resize_function__Sleep_SendGoal_Event__response(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<btcpp_ros2_interfaces::action::Sleep_SendGoal_Response> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sleep_SendGoal_Event_message_member_array[3] = {
  {
    "info",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(btcpp_ros2_interfaces::action::Sleep_SendGoal_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<btcpp_ros2_interfaces::action::Sleep_SendGoal_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(btcpp_ros2_interfaces::action::Sleep_SendGoal_Event, request),  // bytes offset in struct
    nullptr,  // default value
    size_function__Sleep_SendGoal_Event__request,  // size() function pointer
    get_const_function__Sleep_SendGoal_Event__request,  // get_const(index) function pointer
    get_function__Sleep_SendGoal_Event__request,  // get(index) function pointer
    fetch_function__Sleep_SendGoal_Event__request,  // fetch(index, &value) function pointer
    assign_function__Sleep_SendGoal_Event__request,  // assign(index, value) function pointer
    resize_function__Sleep_SendGoal_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<btcpp_ros2_interfaces::action::Sleep_SendGoal_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(btcpp_ros2_interfaces::action::Sleep_SendGoal_Event, response),  // bytes offset in struct
    nullptr,  // default value
    size_function__Sleep_SendGoal_Event__response,  // size() function pointer
    get_const_function__Sleep_SendGoal_Event__response,  // get_const(index) function pointer
    get_function__Sleep_SendGoal_Event__response,  // get(index) function pointer
    fetch_function__Sleep_SendGoal_Event__response,  // fetch(index, &value) function pointer
    assign_function__Sleep_SendGoal_Event__response,  // assign(index, value) function pointer
    resize_function__Sleep_SendGoal_Event__response  // resize(index) function pointer
  }
};

static const ::rosidl_typesupport_introspection_cpp::MessageMembers Sleep_SendGoal_Event_message_members = {
  "btcpp_ros2_interfaces::action",  // message namespace
  "Sleep_SendGoal_Event",  // message name
  3,  // number of fields
  sizeof(btcpp_ros2_interfaces::action::Sleep_SendGoal_Event),
  false,  // has_any_key_member_
  Sleep_SendGoal_Event_message_member_array,  // message members
  Sleep_SendGoal_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  Sleep_SendGoal_Event_fini_function  // function to terminate message instance (will not free memory)
};

static const rosidl_message_type_support_t Sleep_SendGoal_Event_message_type_support_handle = {
  ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  &Sleep_SendGoal_Event_message_members,
  get_message_typesupport_handle_function,
...
{
  return &::btcpp_ros2_interfaces::action::rosidl_typesupport_introspection_cpp::Sleep_SendGoal_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, btcpp_ros2_interfaces, action, Sleep_SendGoal_Event)() {
  return &::btcpp_ros2_interfaces::action::rosidl_typesupport_introspection_cpp::Sleep_SendGoal_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Sleep_SendGoal_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<btcpp_ros2_interfaces::action::Sleep_SendGoal_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<btcpp_ros2_interfaces::action::Sleep_SendGoal_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<btcpp_ros2_interfaces::action::Sleep_SendGoal_Event>(),
...
get_service_type_support_handle<btcpp_ros2_interfaces::action::Sleep_SendGoal>()
{
    ...
    service_members->event_members_ == nullptr)
  {
    ...
    service_members->event_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::btcpp_ros2_interfaces::action::Sleep_SendGoal_Event
      >()->data
      );
  }
...
void Sleep_GetResult_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) btcpp_ros2_interfaces::action::Sleep_GetResult_Event(_init);
}

void Sleep_GetResult_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<btcpp_ros2_interfaces::action::Sleep_GetResult_Event *>(message_memory);
  typed_message->~Sleep_GetResult_Event();
}

size_t size_function__Sleep_GetResult_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<btcpp_ros2_interfaces::action::Sleep_GetResult_Request> *>(untyped_member);
  return member->size();
}

const void * get_const_function__Sleep_GetResult_Event__request(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<btcpp_ros2_interfaces::action::Sleep_GetResult_Request> *>(untyped_member);
  return &member[index];
}

void * get_function__Sleep_GetResult_Event__request(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<btcpp_ros2_interfaces::action::Sleep_GetResult_Request> *>(untyped_member);
  return &member[index];
}

void fetch_function__Sleep_GetResult_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const btcpp_ros2_interfaces::action::Sleep_GetResult_Request *>(
    get_const_function__Sleep_GetResult_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<btcpp_ros2_interfaces::action::Sleep_GetResult_Request *>(untyped_value);
  value = item;
}

void assign_function__Sleep_GetResult_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<btcpp_ros2_interfaces::action::Sleep_GetResult_Request *>(
    get_function__Sleep_GetResult_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const btcpp_ros2_interfaces::action::Sleep_GetResult_Request *>(untyped_value);
  item = value;
}

void resize_function__Sleep_GetResult_Event__request(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<btcpp_ros2_interfaces::action::Sleep_GetResult_Request> *>(untyped_member);
  member->resize(size);
...
size_t size_function__Sleep_GetResult_Event__response(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<btcpp_ros2_interfaces::action::Sleep_GetResult_Response> *>(untyped_member);
  return member->size();
}

const void * get_const_function__Sleep_GetResult_Event__response(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<btcpp_ros2_interfaces::action::Sleep_GetResult_Response> *>(untyped_member);
  return &member[index];
}

void * get_function__Sleep_GetResult_Event__response(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<btcpp_ros2_interfaces::action::Sleep_GetResult_Response> *>(untyped_member);
  return &member[index];
}

void fetch_function__Sleep_GetResult_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const btcpp_ros2_interfaces::action::Sleep_GetResult_Response *>(
    get_const_function__Sleep_GetResult_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<btcpp_ros2_interfaces::action::Sleep_GetResult_Response *>(untyped_value);
  value = item;
}

void assign_function__Sleep_GetResult_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<btcpp_ros2_interfaces::action::Sleep_GetResult_Response *>(
    get_function__Sleep_GetResult_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const btcpp_ros2_interfaces::action::Sleep_GetResult_Response *>(untyped_value);
  item = value;
}

void resize_function__Sleep_GetResult_Event__response(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<btcpp_ros2_interfaces::action::Sleep_GetResult_Response> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sleep_GetResult_Event_message_member_array[3] = {
  {
    "info",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(btcpp_ros2_interfaces::action::Sleep_GetResult_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<btcpp_ros2_interfaces::action::Sleep_GetResult_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(btcpp_ros2_interfaces::action::Sleep_GetResult_Event, request),  // bytes offset in struct
    nullptr,  // default value
    size_function__Sleep_GetResult_Event__request,  // size() function pointer
    get_const_function__Sleep_GetResult_Event__request,  // get_const(index) function pointer
    get_function__Sleep_GetResult_Event__request,  // get(index) function pointer
    fetch_function__Sleep_GetResult_Event__request,  // fetch(index, &value) function pointer
    assign_function__Sleep_GetResult_Event__request,  // assign(index, value) function pointer
    resize_function__Sleep_GetResult_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<btcpp_ros2_interfaces::action::Sleep_GetResult_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(btcpp_ros2_interfaces::action::Sleep_GetResult_Event, response),  // bytes offset in struct
    nullptr,  // default value
    size_function__Sleep_GetResult_Event__response,  // size() function pointer
    get_const_function__Sleep_GetResult_Event__response,  // get_const(index) function pointer
    get_function__Sleep_GetResult_Event__response,  // get(index) function pointer
    fetch_function__Sleep_GetResult_Event__response,  // fetch(index, &value) function pointer
    assign_function__Sleep_GetResult_Event__response,  // assign(index, value) function pointer
    resize_function__Sleep_GetResult_Event__response  // resize(index) function pointer
  }
};

static const ::rosidl_typesupport_introspection_cpp::MessageMembers Sleep_GetResult_Event_message_members = {
  "btcpp_ros2_interfaces::action",  // message namespace
  "Sleep_GetResult_Event",  // message name
  3,  // number of fields
  sizeof(btcpp_ros2_interfaces::action::Sleep_GetResult_Event),
  false,  // has_any_key_member_
  Sleep_GetResult_Event_message_member_array,  // message members
  Sleep_GetResult_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  Sleep_GetResult_Event_fini_function  // function to terminate message instance (will not free memory)
};

static const rosidl_message_type_support_t Sleep_GetResult_Event_message_type_support_handle = {
  ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  &Sleep_GetResult_Event_message_members,
  get_message_typesupport_handle_function,
...
{
  return &::btcpp_ros2_interfaces::action::rosidl_typesupport_introspection_cpp::Sleep_GetResult_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, btcpp_ros2_interfaces, action, Sleep_GetResult_Event)() {
  return &::btcpp_ros2_interfaces::action::rosidl_typesupport_introspection_cpp::Sleep_GetResult_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Sleep_GetResult_service_type_support_handle = {
  ...
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<btcpp_ros2_interfaces::action::Sleep_GetResult_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<btcpp_ros2_interfaces::action::Sleep_GetResult_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<btcpp_ros2_interfaces::action::Sleep_GetResult_Event>(),
...
get_service_type_support_handle<btcpp_ros2_interfaces::action::Sleep_GetResult>()
{
    ...
    service_members->event_members_ == nullptr)
  {
    ...
    service_members->event_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::btcpp_ros2_interfaces::action::Sleep_GetResult_Event
      >()->data
      );
  }
  // finally return the properly initialized service_type_support handle
