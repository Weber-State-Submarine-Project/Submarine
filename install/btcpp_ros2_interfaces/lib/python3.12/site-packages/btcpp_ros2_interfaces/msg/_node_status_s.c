...
bool btcpp_ros2_interfaces__msg__node_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("btcpp_ros2_interfaces.msg._node_status.NodeStatus", full_classname_dest, 49) == 0);
  }
  btcpp_ros2_interfaces__msg__NodeStatus * ros_message = _ros_message;
  {  // status
...
PyObject * btcpp_ros2_interfaces__msg__node_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("btcpp_ros2_interfaces.msg._node_status");
