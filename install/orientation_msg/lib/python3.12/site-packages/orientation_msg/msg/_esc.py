...
class Esc(metaclass=Metaclass_Esc):
    ...
    _fields_and_field_types = {
        'motor_selection': 'string',
        'power_percentage': 'int64',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_selection = kwargs.get('motor_selection', str())
        self.power_percentage = kwargs.get('power_percentage', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.motor_selection != other.motor_selection:
            return False
        if self.power_percentage != other.power_percentage:
            return False
        return True
    ...
    def motor_selection(self):
        """Message field 'motor_selection'."""
        return self._motor_selection
    ...
    def motor_selection(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'motor_selection' field must be of type 'str'"
        self._motor_selection = value

    @builtins.property
    def power_percentage(self):
        """Message field 'power_percentage'."""
    ...
    def power_percentage(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'power_percentage' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'power_percentage' field must be an integer in [-9223372036854775808, 9223372036854775807]"
