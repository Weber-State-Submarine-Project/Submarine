...
class Init_Sleep_SendGoal_Event_response
{
public:
  explicit Init_Sleep_SendGoal_Event_response(::btcpp_ros2_interfaces::action::Sleep_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::btcpp_ros2_interfaces::action::Sleep_SendGoal_Event response(::btcpp_ros2_interfaces::action::Sleep_SendGoal_Event::_response_type arg)
  {
...
private:
  ::btcpp_ros2_interfaces::action::Sleep_SendGoal_Event msg_;
};

class Init_Sleep_SendGoal_Event_request
{
public:
  explicit Init_Sleep_SendGoal_Event_request(::btcpp_ros2_interfaces::action::Sleep_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_Sleep_SendGoal_Event_response request(::btcpp_ros2_interfaces::action::Sleep_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Sleep_SendGoal_Event_response(msg_);
  }
...
class Init_Sleep_SendGoal_Event_info
{
public:
  Init_Sleep_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Sleep_SendGoal_Event_request info(::btcpp_ros2_interfaces::action::Sleep_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Sleep_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::btcpp_ros2_interfaces::action::Sleep_SendGoal_Event>()
{
  return btcpp_ros2_interfaces::action::builder::Init_Sleep_SendGoal_Event_info();
}
...
class Init_Sleep_GetResult_Event_response
{
public:
  explicit Init_Sleep_GetResult_Event_response(::btcpp_ros2_interfaces::action::Sleep_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::btcpp_ros2_interfaces::action::Sleep_GetResult_Event response(::btcpp_ros2_interfaces::action::Sleep_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::btcpp_ros2_interfaces::action::Sleep_GetResult_Event msg_;
};

class Init_Sleep_GetResult_Event_request
{
public:
  explicit Init_Sleep_GetResult_Event_request(::btcpp_ros2_interfaces::action::Sleep_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_Sleep_GetResult_Event_response request(::btcpp_ros2_interfaces::action::Sleep_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Sleep_GetResult_Event_response(msg_);
  }
...
class Init_Sleep_GetResult_Event_info
{
public:
  Init_Sleep_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Sleep_GetResult_Event_request info(::btcpp_ros2_interfaces::action::Sleep_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Sleep_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::btcpp_ros2_interfaces::action::Sleep_GetResult_Event>()
{
  return btcpp_ros2_interfaces::action::builder::Init_Sleep_GetResult_Event_info();
}
