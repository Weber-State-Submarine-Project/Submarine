...
#define NODE_MAIN_LOGGER_NAME "filter_statistical_outlier_removal_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpcl_ros_filters.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pcl_ros::StatisticalOutlierRemoval>";
