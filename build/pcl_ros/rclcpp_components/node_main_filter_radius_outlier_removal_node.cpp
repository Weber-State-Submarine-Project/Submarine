...
#define NODE_MAIN_LOGGER_NAME "filter_radius_outlier_removal_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pcl_ros::RadiusOutlierRemoval>";
